        ...
        <div className="container mx-auto px-4 py-20 relative z-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            ...
            >
              ...
              >
                At Vaigai Sparklers, we are more than just a sparklers factory -
                we are creators of memories. Our factory is set amidst lush
                green surroundings, echoing our deep commitment to
                sustainability and eco-friendliness. We are an ISO-Certified
                Company, and every product we manufacture strictly adheres to Go
                Green principles. Our sparklers are carefully crafted using
                premium materials and time-tested techniques, ensuring each
                piece delivers the safest and most spectacular sparkle possible.
              </motion.p>
              ...
              >
                We currently offer more than 50 varieties of Sparklers, each
                designed with a perfect balance of safety, colour, and quality.
                As part of a green initiative, we plant 50 new trees every year,
                reinforcing our promise to give back to nature.
              </motion.p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <Card className="h-full bg-gradient-to-br from-red-50 to-orange-50 border-red-200 shadow-xl">
                  ...
                  <CardContent className="text-center">
                    <p className="text-gray-700 text-lg leading-relaxed">
                      To spark happiness in every home by delivering safe,
                      vibrant, and eco-conscious sparklers made with care and
                      excellence. Our Vision is to deliver the vibrance of
                      celebration without compromising the health of our planet.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="h-full bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 shadow-xl">
                  ...
                  <CardContent className="text-center">
                    <p className="text-gray-700 text-lg leading-relaxed">
                      We aim to become one of India's most trusted names in
                      sparklers by consistently delivering value, safety, and
                      innovation – while staying true to our cultural roots.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our state-of-the-art manufacturing process ensures quality,
                  ...
                  >
                    <Card className="h-full bg-gradient-to-br from-white to-gray-50 border-gray-200 shadow-lg hover:shadow-xl transition-shadow">
                      <CardHeader className="text-center pb-6">
                        <div className="flex justify-center mb-4">
                          <div
                            className={`p-4 bg-gradient-to-r ${step.color} rounded-full`}
                          >
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl mb-8 max-w-3xl mx-auto">
                Join thousands of satisfied customers who trust Twin Elephant
                Brand for their special moments
              </p>
