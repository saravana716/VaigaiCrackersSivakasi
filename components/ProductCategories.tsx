...
export function ProductCategories({ onCategoryClick }: ProductCategoriesProps) {
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8"> {/* Keep some padding for desktop */}
    {/* Heading */}
    <motion.div
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
  {isLoading ? (
    <p className="text-center text-gray-400 col-span-full">Loading categories...</p>
  ) : categories.length === 0 ? (
    ...
    categories.map((category, index) => (
      ...
      >
        <Card className="bg-gradient-to-br from-gray-900 to-black border-gray-800 overflow-hidden hover:border-gray-600 transition-colors w-full rounded-lg shadow-lg">
